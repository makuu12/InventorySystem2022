...
Public Class LossDamageForm
    ...
    Private Sub btnUpdate_Click_1(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Dim ID, RN, M, P, CAP, EXP, LDP, LDQTY, LD, u, a, d, t As String
        Dim NQTY As Double
        ID = InventoryForm.txtRawID.Text
        NQTY = UpdateForm.lblQTY.Text
        RN = InventoryForm.txtRaw.Text.Trim
        CAP = InventoryForm.txtCap.Text.Trim
        P = InventoryForm.txtPrice.Text.Trim
        LDQTY = UpdateForm.txtUpdate.Text.Trim
        LDP = txtPrice.Text.Trim
        ...
        If cbLoD.SelectedIndex = 0 Then
            LD = "Loss"
        ElseIf cbLoD.SelectedIndex = 1 Then
            LD = "Damaged"
        End If
        If txtPrice.Text = Nothing Then
            MessageBox.Show("Please input the price of the loss/damaged quantity of the raw material!", "", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        ElseIf cbLoD.SelectedIndex = -1 Then
            MessageBox.Show("Please select if the raw material was loss/damaged!", "", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        Else
    ...
    Private Sub cbLoD_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbLoD.SelectedIndexChanged
        If cbLoD.SelectedIndex = -1 Then
